...
export default class TopSlider extends React.Component {
  ...
  loadTopSlider(topSliderItemWidth, topSliderItemCount) {
    topSliderItemWidth =
      document.getElementsByClassName("slide-item")[0].clientWidth;
  ...
  backTopSlider(topSliderItemWidth, topSliderItemCount) {
    if (this.currentTopSliderItem === 1) {
      ...
      topSliderItemWidth =
        document.getElementsByClassName("slide-item")[
          this.currentTopSliderItem - 1
        ].clientWidth;
    } else {
      topSliderItemWidth =
  ...
  componentDidMount() {
    window.addEventListener(
      "load",
      this.loadTopSlider(this.topSliderItemWidth, this.topSliderItemCount)
    );
  }
      ...
      <div className="slider">
        <div className="slides" id="top-slider">
          ...
          <div className="slide-item item3">
            <div className="slide-content">
              ...
              <p>
                Always hunger for new idea creation, we incubate good ideas by
                providing facilities for product development and environment
                where creativity leverages our skills and services.
              </p>
            </div>
          </div>
          <div className="slide-item item4">
            <div className="slide-content">
              ...
              <p>
                Our friendly, challenging, and collaborative environment creates
                enjoy valuable benefits and sharing ownership.
              </p>
            </div>
          </div>
        </div>
        <div className="slider-actions">
          <button
            ...
            onClick={() => {
              this.backTopSlider(
                this.topSliderItemWidth,
                this.topSliderItemCount
              );
            }}
          >
            <img src={Anh_1} />
